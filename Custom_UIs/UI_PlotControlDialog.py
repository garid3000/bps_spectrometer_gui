...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(1, QFormLayout.ItemRole.LabelRole, self._label_5)

        self.le_title = QLineEdit(Dialog)
        self.le_title.setObjectName("le_title")

        self.formLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.le_title)
        ...
        self.formLayout.setWidget(4, QFormLayout.ItemRole.SpanningRole, self._l)

        self._label_7 = QLabel(Dialog)
        self._label_7.setObjectName("_label_7")

        self.formLayout.setWidget(5, QFormLayout.ItemRole.SpanningRole, self._label_7)

        self._label_2 = QLabel(Dialog)
        self._label_2.setObjectName("_label_2")

        self.formLayout.setWidget(6, QFormLayout.ItemRole.LabelRole, self._label_2)

        self.le_y_label = QLineEdit(Dialog)
        self.le_y_label.setObjectName("le_y_label")

        self.formLayout.setWidget(6, QFormLayout.ItemRole.FieldRole, self.le_y_label)

        self._label_3 = QLabel(Dialog)
        self._label_3.setObjectName("_label_3")

        self.formLayout.setWidget(7, QFormLayout.ItemRole.LabelRole, self._label_3)
        ...
        self.formLayout.setWidget(8, QFormLayout.ItemRole.LabelRole, self._label_4)
        ...
        self.formLayout.setWidget(9, QFormLayout.ItemRole.SpanningRole, self._l_2)

        self._label_8 = QLabel(Dialog)
        self._label_8.setObjectName("_label_8")

        self.formLayout.setWidget(10, QFormLayout.ItemRole.SpanningRole, self._label_8)

        self._label_9 = QLabel(Dialog)
        self._label_9.setObjectName("_label_9")

        self.formLayout.setWidget(11, QFormLayout.ItemRole.LabelRole, self._label_9)

        self.le_x_label = QLineEdit(Dialog)
        self.le_x_label.setObjectName("le_x_label")

        self.formLayout.setWidget(11, QFormLayout.ItemRole.FieldRole, self.le_x_label)

        self._label_10 = QLabel(Dialog)
        self._label_10.setObjectName("_label_10")

        self.formLayout.setWidget(12, QFormLayout.ItemRole.LabelRole, self._label_10)
        ...
        self.formLayout.setWidget(13, QFormLayout.ItemRole.LabelRole, self._label_6)
        ...
        self.formLayout.setWidget(14, QFormLayout.ItemRole.SpanningRole, self._l_3)

        self.cb_grid = QCheckBox(Dialog)
        self.cb_grid.setObjectName("cb_grid")

        self.formLayout.setWidget(2, QFormLayout.ItemRole.FieldRole, self.cb_grid)

        self.cb_legend = QCheckBox(Dialog)
        self.cb_legend.setObjectName("cb_legend")
        self.cb_legend.setChecked(True)

        self.formLayout.setWidget(3, QFormLayout.ItemRole.FieldRole, self.cb_legend)

        self._label_1 = QLabel(Dialog)
        self._label_1.setObjectName("_label_1")

        self.formLayout.setWidget(0, QFormLayout.ItemRole.SpanningRole, self._label_1)
        ...
        self.formLayout.setWidget(16, QFormLayout.ItemRole.LabelRole, self._label_11)

        self._label_12 = QLabel(Dialog)
        self._label_12.setObjectName("_label_12")

        self.formLayout.setWidget(17, QFormLayout.ItemRole.LabelRole, self._label_12)
        ...
        self.formLayout.setWidget(15, QFormLayout.ItemRole.SpanningRole, self._label)

        self._label_13 = QLabel(Dialog)
        self._label_13.setObjectName("_label_13")

        self.formLayout.setWidget(18, QFormLayout.ItemRole.LabelRole, self._label_13)
